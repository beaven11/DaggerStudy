...
import com.beaven.daggerstudy.widget.indicators.BallPulseIndicator;
import com.beaven.daggerstudy.widget.indicators.Indicator;
...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final TypedArray a =
                context.obtainStyledAttributes(attrs, R.styleable.AVLoadingIndicatorView,
        ...
        mIndicatorColor =
                a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor, Color.WHITE);
    ...
    public void setIndicator(String indicatorName) {
        ...
        Log.d(TAG, "drawableClassName--" + drawableClassName.toString());
        try {
